...
import { SelectNumberPerson } from "@/components/functions";
type HotelData = {
  name: string;
  details: [string];
  location: string;
      ...
      {data ? (
        <div className="w-full h-full px-20 py-5">
          <h1 className="text-center my-3 text-[1.1rem] font-medium underline mb-6">
            Lưu ý: tất cả các ảnh của chúng tôi là ảnh thật. Giá đã bao gồm thuế
            VAT
          </h1>
          <div className="flex items-center justify-between border-b-[1px] pb-6 border-[#888] mb-6 ">
            <div
          ...
          <div className="w-full" id="overview">
            ...
            <address className="my-3 flex_dou">
              <IoLocation className="text-red-400 text-[1.4rem]" />
              {data.location}
            </address>
          ...
          <div className="w-full h-full" id="info_utilities">
            ...
            <div className="flex items-center my-5">
              ...
              <span>
                ...
                hoặc trước 2 ngày đến lịch đặt ( ngoài thời gian quy định chúng
                tôi sẽ trừ tiền chiết khấu với quý khách )
              </span>
            </div>
            {/* content */}
            ...
            {/* booking */}
            <div className="w-full h-full p-3 bg-sub rounded-xl " id="price">
              <h3 className="title_large">Chọn ngày nhận và trả phòng</h3>
              <div className="flex_dou bg-red-400 text-white rounded-xl">
                <CalendarIcon className="mr-3 text-white h-[1.3rem] w-[1.3rem]" />
                <DatePicker />
              </div>
                ...
                <table className="table__booking w-full">
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td>
                        <div>
                          <h5 className="title_small text-red-400">
                            Giảm giá:
                            <span>
                              {data.sales}%{" "}
                        ...
                        <Button className="mr-3 bg-red-400">Đặt ngay</Button>
            ...
            {/* regulations */}
            <div className="border_div_card my-3" id="general_rule">
              ...
              <div>
                ...
                <p className="p_type_2">
                  ...
                  kiểm tra thông tin phòng để biết thêm chi tiết. Tất cả trẻ em
                  đều được chào đón.
                </p>
              </div>
