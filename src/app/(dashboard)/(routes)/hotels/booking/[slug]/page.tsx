...
const BookingHotelPage = () => {
  ...
  useEffect(() => {
    const fetchData = async () => {
      setIsLoading(true);
      try {
        const tourData = await getDetailHotel({ slug });
        ...
        <Suspense fallback={<Loading />}>
          ...
          >
            ...
            >
              ...
              >
                <ChevronLeft />
                <span className="ml-2">Loại chỗ nghỉ</span>
              </div>
              <div
              ...
              <p>Được đảm bảo an toàn về mọi mặt</p>
            </div>
            {/* body */}
            <div
              className={cn(
                "w-full flex flex-col-reverse items-center justify-center gap-4 mt-4  ",
            ...
            >
              ...
              >
                ...
                <FormInput
                  type="text"
                  title="Bạn có yêu cầu riêng cho khách sạn không "
                  value=""
                  ...
                  <div className="w-full flex items-center justify-start gap-x-2 ">
                    ...
                    {dateFrom && dateTo && (
                      <div className="flex items-center justify-start gap-2">
                        <div>
                          <span>Từ ngày </span>
                          <span className="text-blue_main_sub font-semibold">
                            {String(dateFrom)}
                          </span>
                        </div>
                        <div>
