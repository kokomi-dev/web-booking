  ...
  return (
    <section className="flex flex-col w-full">
      <Button
        ...
        variant="ghost"
        className={cn(
          "flex w-full h-[44px] bg-white px-2 py-1 text-base font-light",
      ...
      >
        {date?.from ? (
          date.to ? (
            <span className="w-full h-full flex items-center justify-start gap-x-1 text-sm md:text-base font-light">
