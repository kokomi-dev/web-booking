...
function Calendar({
  ...
  return (
    <DayPicker
      ...
      classNames={{
        months:
          "w-full flex flex-col sm:flex-row space-y-1 sm:space-x-2 md:space-x-5 lg:space-x-12 sm:space-y-0",
        month: "space-y-4 w-full",
        caption: "w-full flex justify-center pt-1 relative items-center",
        caption_label: "text-base lg:text-sm font-semibold",
        ...
        head_row: "flex border-t-1 border-blue_sub py-1",
        head_cell: "w-full text-sm lg:text-sm font-medium rounded-md w-8",
        ...
        day_selected:
          "bg-blue_sub hover:bg-blue_active hover:text-white  text-white font-semibold",
        day_today:
          "bg-white font-semibold text-yellow border-black_sub border-1 pointer-events-none",
        day_outside:
        ...
        day_range_middle:
          "aria-selected:bg-blue_sub hover:bg-blue_active aria-selected:text-white",
