  ...
  return (
    <div className="list-spacing">
      <div className="flex items-center justify-between flex-wrap">
        <h2 className="text-xl lg:text-2xl font-medium text-nowrap">
          Về KoKoTravel
        </h2>
        <div
          className="hide-print flex items-center justify-start gap-1 hover:opacity-85 hover: cursor-pointer p-2  text-blue_sub text-base font-medium"
  ...
  return (
    <div className="list-spacing">
      <div className="flex items-center justify-between flex-wrap">
        ...
        <div
          className="flex items-center justify-start hover:opacity-85 hover: cursor-pointer p-2  gap-1 text-blue_sub text-base font-medium"
          onClick={printContent}
        >
          <Printer className="size-4" />
          In
...
const Page3 = () => {
  return (
    <div className="list-spacing">
      ...
      <div className="list-spacing">
        <p className="text-xs font-normal text-black_sub">
      ...
      <div className="list-spacing">
        ...
        <div className="grid gap-2">
          ...
          <p className="text-sm font-normal">
            ...
            <a href="tel:+84123456789" className="text-blue_sub">
              +0961564888
            </a>
          </p>
          <p className="text-sm font-normal">
  ...
  return (
    <div className="list-spacing">
      ...
      <div className="list-spacing">
        ...
        <h3 className="text-lg font-semibold">Cách thức tham gia</h3>
        <p className="text-sm font-normal">
        ...
        <ol className="list-decimal pl-5">
          <li className="text-sm font-normal">
            ...
            <a href="/partnership-form" className="text-blue_sub">
              đây
            </a>
            .
          </li>
